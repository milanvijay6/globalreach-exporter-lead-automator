...
import { Importer, Channel, LeadStatus, Language, MessageStatus, EmotionLabel, SentimentData, Message } from '../types';
      ...
      {activeTab === 'chat' ? (
          <>
            ...
            <div 
                ...
                className="flex-1 overflow-y-auto p-4 bg-slate-50 bg-[url('https://www.transparenttextures.com/patterns/subtle-white-feathers.png')] min-h-0"
                style={{ overflowY: 'auto', WebkitOverflowScrolling: 'touch', contain: 'strict' }}
            >
                {importer.chatHistory.length === 0 ? (
                    ...
                    >
                        {virtualizer.getVirtualItems().map((virtualRow) => {
                            const msg = importer.chatHistory[virtualRow.index];
                            return (
                                <div
                                    key={virtualRow.key}
                                    style={{
                                    ...
                                    className="px-0"
                                >
                                    <MessageBubble message={msg} onMessageFeedback={onMessageFeedback} />
                                </div>
                            );
                        })}
                    </div>
                    ...
                    <>
                        <div className="flex gap-2 mb-2 overflow-x-auto pb-2 scrollbar-hide" style={{ WebkitOverflowScrolling: 'touch' }}>
                            ...
                            <OptimizedButton
                                ...
                                variant={isEscalated || isCritical ? "ghost" : "primary"}
                                size="sm"
                                className={`whitespace-nowrap ${isEscalated || isCritical ? 'bg-gray-100 text-gray-400' : ''}`}
                            >
                        ...
                        <div className="flex gap-2 items-center">
                            ...
                            <OptimizedButton
                                ...
                                variant="primary"
                                className="shrink-0 !p-2 !rounded-full shadow-md"
